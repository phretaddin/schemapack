...
case"buffer":return"bag.writeBuffer("+r+", wBuffer);"}}function b(t){return 0>=t?1:Math.floor(Math.log(t)/Math.log(128))+1}function w(t){return b(t<<1^t>>31)}function d(t,r,e,n,i){var o=1>=n?r:r-1+"xn",f=void 0===i?"ref"+o+".length":i,u="j"+r
return"for (var "+u+"="+(t.length-1)+";"+u+"<"+f+";"+u+"++) { "+e+"}"}function v(t){return"byteC+=bag.getVarUIntByteLength(ref"+t+".length);"}function E(t){return"bag.writeVarUInt(ref"+t+".length,wBuffer);"}function A(t){return"var "+t+"=bag.readVarUInt(buffer);"}function B(t,r,e,n){return"var ref"+t+"="+n+"; ref"+r+"["+e+"]=ref"+t+";"}function m(t,r,e){return"var ref"+t+"=ref"+r+"["+e+"];"}function O(t,r,e,n,i,o,f){var u=C(i,r),a=t?"j"+r:e
i[i.length-1]+=m(r+"xn",u,a),o[o.length-1]+=B(r+"xn",u,a,n),f[f.length-1]+=m(r+"xn",u,a)}function _(t,r,e,n,i){if(typeof t!==r)throw new TypeError(t+" does not match the type of "+r)
...
return n?"byteC+="+N[t]+";":"byteC+=bag.dynamicByteCounts['"+t+"'](ref"+r+e+");"}function C(t,r){return t.length<=2&&t[t.length-1].length<=0?r:r-1+"xn"}function L(t,r){function e(t,y){a++
var b=Object.keys(t)
...
if(L&&(s.push(""),h.push(""),c.push("")),U.constructor===Array){var x=a+1,M=s.length<=1?x:w+"xn",D="arrLen"+a
1===s.length&&(u+=m(x,w,T),o+=B(x,w,T,"[]"))
var k=E(M),j=A(D),V=v(M)
O(L,w,T,P,s,h,c),e(U,!0),l=k+d(U,x,s.pop()+l,s.length),g=j+d(U,x,h.pop()+g,s.length,D),p=V+d(U,x,c.pop()+p,s.length),1===s.length&&(n+=l,l="",o+=g,g="",f+=p,p="")}else if("object"==typeof U){var x=a+1
1===s.length&&(u+=m(x,w,T),o+=B(x,w,T,"{}")),O(L,w,T,P,s,h,c),e(U,!1)}else{var N=y?"":"["+T+"]",F=i(U)
t[R]=F
var M=C(s,w)
...
return n(r,X)},decode:function(t){var r=t instanceof ArrayBuffer?q(t):t
